...
def Search():
    ...
    try:
        ...
        messagebox.showinfo('บันทึกสำเร็จ','ค้าหาข้อมูลสำเร็จ บันทึกเรียบร้อยแล้ว')
    except:
        #หากรันคำสั่งแล้มีปัญหา แสดงข้อความแจ้งเตือน
...
B1.pack(pady=10)#ipadx ขยายภายในปุ่มแนวนอน
